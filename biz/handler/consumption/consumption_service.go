...
// GetTotalOut .
// @router /api/consumption/out/sum [GET]
func GetTotalOut(ctx context.Context, c *app.RequestContext) {
	resp := new(consumption.GetSumByRangeResponse)
...
// GetSumIn .
// @router /api/consumption/in/month/sum [GET]
func GetSumIn(ctx context.Context, c *app.RequestContext) {
	var err error
	resp := new(consumption.GetSumByRangeResponse)
	d := c.Query("date")
